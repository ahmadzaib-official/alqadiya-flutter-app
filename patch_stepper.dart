...
class QuestionStepper extends StatefulWidget {
  ...
  const QuestionStepper({
    ...
    this.pastColor = const Color(0xFF141B25),
...
class _QuestionStepperState extends State<QuestionStepper>
  ...
  Widget build(BuildContext context) {
    // Determine how many nodes to show. If totalQuestions is 0, default to 1.
    ...
    return Row(
      ...
      children: List.generate(total, (index) {
          ...
          node = GestureDetector(
            onTap: () {
              if (widget.onQuestionTapped != null) {
                // index is 0-based for the callback
        ...
        return Row(
          ...
          children: [
            node,
            Container(width: 25, height: 2, color: widget.lineColor),
          ],
        );
      }),
    );
