...
class ScoreboardModel {
    ...
    factory ScoreboardModel.fromJson(Map<String, dynamic> json){ 
        return ScoreboardModel(
            ...
            currentQuestion: json["currentQuestion"] == null ? null : CurrentQuestion.fromJson(json["currentQuestion"]),
...
class Team {
    ...
    factory Team.fromJson(Map<String, dynamic> json){ 
        return Team(
            ...
            questionProgress: json["questionProgress"] == null ? [] : List<QuestionProgress>.from(json["questionProgress"]!.map((x) => QuestionProgress.fromJson(x))),
