...
void main() {
  ...
  // Remove unlockedEvidenceIds
  content = content.replaceFirst('var isMoreLoading = false.obs;\n  var unlockedEvidenceIds = <String>[].obs;', 'var isMoreLoading = false.obs;');
...
''';
  ...
  if (content.contains('Jugaar')) {
    ...
    print('Reverted EvidenceController successfully.');
  } else {
    print('No jugaar found to revert.');
  }
}
